...
class MemberRepositoryTest {
    ...
    public void returnType() {
        ...
        System.out.println("aaa = " + aaa.get(0));
    ...
    public void paging() {
        ...
        /**
         * Entity Member를 Controller에 반환해서는 안됨
         * Entity -> DTO로 반환해야함.
         */
        Page<Member> page = memberRepository.findByAge(age, pageRequest);

        //Page<MemberDto> dtoMap = page.map(member -> new MemberDto(member.getId(), member.getUsername()));
    ...
    public void slice() {
        ...
        Slice<Member> page = memberRepository.findListByAge(age, pageRequest);
